...
export const libraryGroups: readonly LibraryGroup[] = [
  ...
  },
  {
    ...
    philosophers: [
      ...
      { id: "anaximander", name: "Anaximandro" },
      { id: "anaximenes", name: "Anaxímenes" },
      { id: "pythagoras", name: "Pitágoras" },
      { id: "heraclitus", name: "Heráclito" },
      { id: "parmenides", name: "Parmênides" },
      { id: "zeno", name: "Zenão" },
      { id: "empedocles", name: "Empédocles" },
      { id: "anaxagoras", name: "Anaxágoras" },
    ...
    chapters: [
      ...
      {
        id: "anaximander",
        title: "Anaximandro e o ápeiron",
        status: "locked",
        progressPct: 0,
        guide: "com Anaximandro",
        stageLabel: "Em breve",
      },
      {
        id: "anaximenes",
        title: "Anaxímenes e o ar",
        status: "locked",
        progressPct: 0,
        guide: "com Anaxímenes",
        stageLabel: "Em breve",
      },
      {
        id: "pythagoras",
        title: "Pitágoras e a harmonia",
        status: "locked",
        progressPct: 0,
        guide: "com Pitágoras",
        stageLabel: "Em breve",
      ...
      {
        id: "empedocles",
        title: "Empédocles e as quatro raízes",
        status: "locked",
        progressPct: 0,
        guide: "com Empédocles",
        stageLabel: "Em breve",
      },
      {
        id: "anaxagoras",
        title: "Anaxágoras e o noûs",
        status: "locked",
        progressPct: 0,
        guide: "com Anaxágoras",
        stageLabel: "Em breve",
      },
      {
        id: "democritus",
