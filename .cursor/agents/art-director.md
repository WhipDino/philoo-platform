...
- **Prisioneiro da trilogia:** o de A Subida / O Retorno é o mesmo que olhou para trás em As Sombras (meio da parede). Âncora: `public/images/story/cave-first-turn-cliffhanger-v1.png`. Não invente outro protagonista.
- **Não use** `beat-05-sombras-la-fora` nem `beat-06-reflexos-na-agua` como “lá fora”: ainda parecem interior de caverna.
