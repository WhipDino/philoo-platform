...
- Novidade decorativa é removida — só fica se serve ao aprendizado.
- Contexto de escola: tolerância a repetição é maior que em app de lazer, pressão de retenção deve ser menor.
